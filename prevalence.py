...
class StatePrevalence(ModelInputs):
    ...
    def calculate_disease_prevalence_per_age_cohort(self):
        """ """
        zeros_column = np.zeros(len(self.NAFLD_inputs.index))
        ...
        return pd.DataFrame(disease_prevalence_data, index=self.NAFLD_inputs.index)

    def calculate_NAFLD_per_age_cohort(self):
        # Multiply NAFLD prevalence by age by sample per age cohort
        return self.NAFLD_inputs['NAFLD prevalence by age'] * self.NAFLD_inputs['Sample per cohort']
    ...
    def calculate_no_NAFLD_per_age_cohort(self):
        ...
        return self.NAFLD_inputs['Sample per cohort'] - self.calculate_NAFLD_per_age_cohort()
    ...
    def calculate_fibrosis_per_age_cohort(self, disease_state):
        ...
        return self.NAFLD_inputs['Disease Prevalence Adjustment'] \
               * self.other_disease_inputs.loc[disease_state]['Non-age specific prevalence'] \
    ...
    def calculate_total_cirrhosis_per_age_cohort(self):
        ...
        return self.NAFLD_inputs['Disease Prevalence Adjustment'] \
               * self.other_disease_inputs.loc['DCC']['Non-age specific prevalence'] \
               * self.NAFLD_inputs['Sample per cohort']
    ...
    def calculate_NASH_HCC_per_age_cohort(self, fibrosis_states_per_age_cohort):
        ...
        return self.NAFLD_inputs['Disease Prevalence Adjustment'] \
               * self.other_disease_inputs.loc['HCC']['Non-age specific prevalence'] \
    ...
    def calculate_cirrhosis_LT_per_age_cohort(self):
        ...
        return self.NAFLD_inputs['Disease Prevalence Adjustment'] \
               ...
               * self.other_disease_inputs.loc['LT']['Non-age specific prevalence']
